...
const weeklyPracticePlan = [
  {
    weekId: 1,
    lesson: 'Создать личного GPT/Gem-наставника и прогнать идею через 10 вопросов',
    artifact: 'coach-link + idea-verdict + vision-board',
    handoff: {
      tool: 'Gemini / Gem',
      action: 'Создайте личного MVP-наставника и попросите его проверить идею через 10 коротких вопросов.',
      bringBack: 'Ссылка/скрин ассистента, verdict по идее, первый сценарий и визуальный prompt.',
    },
    homework: [
      'Создать личного GPT/Gem-наставника по MVP',
      'Провести интервью "10 ударов по идее" и сохранить verdict',
      'Сделать визуальный вау-тест идеи и media prompt',
    ],
  },
  {
    weekId: 2,
    lesson: 'Собрать внешний прототип и разобрать его в handoff-пакет',
    artifact: 'prototype-autopsy + PROJECT_BRIEF.md + AGENTS.md',
    handoff: {
      tool: 'Google AI Studio / Lovable / Antigravity',
      action: 'Сначала соберите 1–2 экрана во внешнем prompt-to-app сервисе, затем проведите Prototype Autopsy и только после этого передайте handoff-пакет в Antigravity.',
      bringBack: 'Ссылка/скрины прототипа, PROTOTYPE_AUTOPSY.md, Screen Map и AGENTS.md.',
    },
    homework: [
      'Собрать внешний прототип без логина, платежей и реальных данных',
      'Разобрать прототип через Keep/Kill/Risk/Transfer',
      'Собрать handoff-пакет для Antigravity',
    ],
  },
  {
    weekId: 3,
    lesson: 'Оживить сцену в песочнице и перенести workflow в Antigravity',
    artifact: 'working-snapshot + transfer-prompt + reviewer-notes',
    handoff: {
      tool: 'Antigravity Manager',
      action: 'Повторите рабочую сцену через Builder-агента, а Reviewer попросите проверить diff, preview, безопасность и лишние зависимости.',
      bringBack: 'Рабочий snapshot, screenshot/walkthrough, changed files, risks и 3 вывода по работе агента.',
    },
    homework: [
      'Собрать AI Pulse Button и рабочую сцену своей сущности',
      'Сделать snapshot/commit после рабочего состояния',
      'Подготовить Antigravity Transfer Prompt и Reviewer notes',
    ],
  },
  {
    weekId: 4,
    lesson: 'Провести AI Red Team, internal preview и Launch Show',
    artifact: 'red-team-list + preview-link + launch-show-pack',
    handoff: {
      tool: 'Gemini / GPT / Antigravity',
      action: 'Запустите внешнего Red Team/QA-reviewer, затем попросите Demo Coach собрать 5 слайдов, речь на 3 минуты и маршрут живого демо.',
      bringBack: 'Red Team выводы, Preview-ссылка, QA-review, Launch Show pack и roadmap из 3 улучшений.',
    },
    homework: [
      'Прогнать Red Team и закрыть XSS/Quality Gate',
      'Опубликовать внутренний preview и получить QA-review',
      'Сохранить Launch Show pack и roadmap следующих 3 улучшений',
    ],
  },
] as const;
